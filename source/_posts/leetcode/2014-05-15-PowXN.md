...
Second approach, __divide and conquer__ which is explained in [this blog](http://fisherlei.blogspot.sg/2012/12/leetcode-powx-n.html) and [this repo](https://github.com/yuanx/leetcode/blob/master/Pow.java). 
